...
public class  PeopleController {
    ...
    public String show(@PathVariable("id") int id, Model model) {
        ...
        /** возвращаем из этго метода название того шаблона, где будет показываться этот человек */
        return "people/show";
    }
    ...
    public String create (@ModelAttribute("person") @Valid Person person,
        ...
        /** вызываем проверку уникальность имени на базе данных,
        ...
        /** Объект класса person мы пишем в базу данных с помощью DAO
