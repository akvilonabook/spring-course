...
public class PeopleController {
     ...
     * создавать нового человека добавлять его в базу данных  */
     ...
     нового человека в базу данных. Для того чтобы создать новый объект класса person
      ...
      из той html формм, которую мы организуем в файле new.html */
    ...
    public String create (@ModelAttribute("person") Person person) {
        ...
        /** после того когда мы добавим человека в нашу базу данных мы должны вернуть какую то страницу
         * клиенту (для пользователя) Можно создать страницу успешного создания пользователя и эту
         * страницу возвращать пользователю, но мы сделаем по другому и будем использовать механизм
         * который называется Редирект. redirect - это механизм, который говорит браузеру перейти
